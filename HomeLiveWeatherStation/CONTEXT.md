...
- [ ] Подключение к Wi-Fi (менеджер соединений).
...
1. **Reliability:** Нужно проверить чтобы при выходе из строя датчиков ESP32 не впадал в ошибку.
1. **Wi-Fi Manager:** Нужна реализация стабильного подключения с реконнектом.
