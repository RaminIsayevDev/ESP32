 ...
 *  STATIC PROTOTYPES
 **********************/
void st7735s_send_cmd(uint8_t cmd);
void st7735s_send_data(void * data, uint16_t length);
void st7735s_send_color(void * data, uint16_t length);
void st7735s_set_orientation(uint8_t orientation);
void axp192_write_byte(uint8_t addr, uint8_t data);
void axp192_init();
void axp192_sleep_in();
void axp192_sleep_out();
